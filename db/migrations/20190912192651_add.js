...
exports.up = function(knex) {
  return Promise.all([
    knex.schema.createTable('feature_names', function(table) {
    ...
    knex.schema.createTable('feature_values', function(table) {
    ...
    knex.schema.createTable('product_feature_join', function(table) {
